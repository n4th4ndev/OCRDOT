...
- Manages API key for cloud mode
...
- **Caching**: Model downloads are cached locally

## Processing Modes

### Cloud Mode (Default)
- No local setup required
- Rate limits: Limited free calls or increased with API key
- API key from: https://app.nanonets.com/#/keys
