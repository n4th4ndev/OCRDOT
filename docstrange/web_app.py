...
def run_web_app(host='0.0.0.0', port=8000, debug=False):
    ...
    if gpu_available:
        ...
        print("💻 GPU not available - using cloud processing mode")
        print("🔄 Initializing cloud processing...")
        # Initialize cloud extractor without downloading models
        try:
            extractor = DocumentExtractor()
            print("✅ Cloud processing initialized successfully")
        except Exception as e:
